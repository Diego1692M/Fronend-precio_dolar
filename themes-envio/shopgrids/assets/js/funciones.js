const url = 'https://backend-prueba-g0si.onrender.com/envio'
...
function deleteEnvio(id){
    ...
    fetch('https://backend-prueba-g0si.onrender.com/envio?registro_envio='+id, {
        method: 'DELETE',
        mode: 'cors',
...
const obtenerDatoEspecifico = async () => {
    ...
    const precioDolarInput = document.getElementById('precio_dolar');
